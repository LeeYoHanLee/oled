...
/*
	SSD1306_WRITECOMMAND(0xAD); //MASTER
	...
	SSD1306_WRITECOMMAND(0x00);  //RESET

	SSD1306_WRITECOMMAND(0x20); //Set Memory Addressing Mode
	SSD1306_WRITECOMMAND(0x02); //Set Page Start Address for Page Addressing Mode,0-7

	SSD1306_WRITECOMMAND(0x00); //---set low column address
	SSD1306_WRITECOMMAND(0x10); //---set high column address
	SSD1306_WRITECOMMAND(0x40); //--set start line address
	SSD1306_WRITECOMMAND(0xA6); //--set contrast control register

	SSD1306_WRITECOMMAND(0xDB); //--set vcomh
	SSD1306_WRITECOMMAND(0x3C); // ~0.83 xVcc

	SSD1306_WRITECOMMAND(0xA4); // DISPLAY ON

	SSD1306_WRITECOMMAND(0x81); //Set Constrast Control
	SSD1306_WRITECOMMAND(0xA0); //

	SSD1306_WRITECOMMAND(0xD5); //--set display clock divide ratio/oscillator frequency
	SSD1306_WRITECOMMAND(0x71); //--set divide ratio
...
void oled_printf(uint16_t x, uint16_t y, FontDef_t* Font, uint8_t color, const char *fmt,...)
{
	va_list ap;
...
// TFT_ShowString( x, y, string , FontColor, BgColor)	;
